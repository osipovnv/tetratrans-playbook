# Уровни аналитиков
https://tookuatro-my.sharepoint.com/:u:/g/personal/mee_tetratrans_ru/EXoVieGIqt5Nm735Fq4ZVekBRMzQ0oiCJFy3_KrXw7Iglg?e=JztRV5
## Базовые ожидания
...
Роль может быть назначена аналитику после прохождения аттестации на Middle+ и выше и не является должностью. Роль назначается сотруднику с подходящими по профилю hard и soft скиллами и подразумевает больше ответственности, вовлеченности в процесс и высокий уровень компетенций, а не переход с ролевой модели "исполнитель" на "руководитель". 

## Краткое описание грейдов

* **Student** Развивается и обучается с помощью более опытных коллег. Он получает заранее формализованные задачи уровня "фича", а взаимодействие с заказчиком по поставленным задачам происходит с помощью наставника (аналитика уровня middle или выше) или техлида/тимлида. "Учение - свет"
...
* **Middle** Отвечает за аналитику направления/сегмента. Решает открытые проблемы и влияет на резултаты поставленных заказчиком бизнес-целей. Самостоятельно планирует время на реализацию поставленных задач и принимает решение о необходимости создания задач формата "техдолг". "Я улучшаю продукт".
...
* **Skills.** Аналитику для работы необходимы следующие hard и soft скиллы:
  ...
  * Конкретизация и расстановка акцентов (умение конкретизировать "расплывчатое", акцентировать внимание на "важном").
...
Для определения/уточнения объёма аналитических работ по задаче мы используем понятие «сложность». 
...
* **Не придумал название, но тут про набор текста** Определяет временные затраты на написание постановки задачи/технического задания/инструкции/обучающего материала, как набора текста. Сложная с точки зрения анализа задача может не требовать обширного описания. Простая с точки зрения анализа задача может потребовать обширного описания.
...
От аналитика уровня Junior ожидается рост до Middle в течении полугода-года. К грейду Middle должны стремиться все аналитики, дальнейший рост желателен, но не является обязательным.
Для подтверждения грейда Middle аналитик уровня Junior должен самостоятельно провести исследование, описание и защиту нескольких задач уровня Middle (сегмент) или воплотить аналитический проекта уровня Middle+ (крупная разработка формата проект/продукт) и провести его презентацию/защиту на интервью с техлидом/тимлидом и аналитиками уровня Middle+.
