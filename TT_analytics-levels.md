...
* **Middle** Отвечает за аналитику направления/сегмента. Решает открытые проблемы и влияет на резултаты поставленных заказчиком бизнес-целей. Самостоятельно планирует время на реализацию поставленных задач и принимает решение о необходимости создания задач на разработку формата "техдолг". "Я улучшаю продукт".
...
Для определения/уточнения уровня объёма задачи на аналитику мы используем понятие «сложность». 
